...
update_batchs=(1024K 2048K 4096K 16K 32K 64K 128K 256K 512K 8192K 16384K)
...
do 
    ...
    do 
        ...
        do 
            ...
            ../bpt_test ../data_set/insert_$ts.txt ../data_set/search_uniform.txt 12 ../data_set/update_${ub}> tmp
