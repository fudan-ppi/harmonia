...
distribution=(uniform normal gamma)
datename=$(date +%Y%m%d-%H%M%S)
tree_name="full-multi-prefix-sort-1thread-notransfer"
#tree_name="hb+"
#rm *_result
...
do 
    ...
    do 
        ...
        do 
            j=0
            ../bpt_test ../data_set/insert_$ts.txt ../data_set/search_200M_${distr}.txt 43 > tmp
