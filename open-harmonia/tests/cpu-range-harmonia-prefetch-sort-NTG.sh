...
tree_name="cpu-range-harmonia-prefetch-sort-NTG"
...
do 
    ...
    do 
        ...
        do 
            ...
            ../bpt_test ../data_set/insert_$ts.txt ../data_set/range_${distr}.txt 59 > tmp
            ...
            do  
                ...
                then 
                    echo "sort time  + $a"
                    sort_time=$(echo "scale=6; $sort_time + $a" | bc)
                fi 
                if [ $j -eq 1 ] 
                then 
                    echo "search time  + $a"
        ...
        sort_time=$(echo "scale=6;$sort_time / $N" | bc)
